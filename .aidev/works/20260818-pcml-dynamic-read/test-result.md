...
`scripts/verify-pcml-dynamic.mjs`。IBM の `RUser.pcml`（`USRI0300`）をそのまま使った。
...
### 2. 呼ぶ
  ...
  PASS 呼び出しが成功
### 3. 先頭から順に解く
  bytesReturned = "784"   bytesAvailable = "784"   userProfileName = "USER"
...
`scripts/verify-browser-pcml-dynamic.mjs`
