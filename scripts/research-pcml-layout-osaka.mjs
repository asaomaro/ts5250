...
//
// `research-pcml-osaka.mjs` で吐かせた PCML はこう言っている:
...
//
// 実行: node --env-file=.env scripts/research-pcml-layout-osaka.mjs
// 前提: research-pcml-osaka.mjs で ASAOLIB/PCMLTST を作ってあること。
