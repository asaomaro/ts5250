...
// 実行: node --env-file=.env scripts/verify-browser-3270-keys-osaka.mjs
...
const sys = { id: "sys1", name: "SR-OSAKA", host, signon: { user, passwordEnv: "AS400_PASSWORD" }, ccsid: 930 };
...
try {
  ...
  const pick = page.locator(".card", { hasText: "SR-OSAKA" }).locator("button", { hasText: "選択" });
